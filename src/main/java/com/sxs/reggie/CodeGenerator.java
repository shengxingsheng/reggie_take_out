...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("sxs");    //设置作者
        ...
        packageInfo.setParent("com.sxs.reggie");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        packageInfo.setEntity("entity");    //设置实体类包名
        packageInfo.setMapper("mapper");   //设置数据层包名
        packageInfo.setXml("mapper.xml");
        autoGenerator.setPackageInfo(packageInfo);

        //策略设置
        StrategyConfig strategyConfig = new StrategyConfig();
        strategyConfig.setInclude("employee");  //设置当前参与生成的表名，参数为可变参数
        ...
        strategyConfig.setColumnNaming(NamingStrategy.underline_to_camel); //驼峰
